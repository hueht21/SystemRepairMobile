...
class BaseGetxController extends GetxController {
  ...
  // RxBool isDarkMode = RxBool(appData.read(AppConst.keyIsDarkTheme) ?? false);
  ...
  //       if (errorContent.contains(AppStr.error401.tr)) {
  //         ShowPopup.showErrorMessage(errorContent, isExpiredToken: true);
  //       } else {
  ...
  //
  //   isDarkMode.toggle();
  //   appData.write(AppConst.keyIsDarkTheme, isDarkMode.value);
  //   Get.forceAppUpdate();
